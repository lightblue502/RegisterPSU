...
angular.module('app', ['ionic', 'app.controllers', 'app.routes', 'app.directives','app.services','app.mocks', 'ngLodash', 'ui.select', 'ngSanitize', 'ngCordova'])
